...
Prospective students should start with the [research overview](/research/) and the [Computational Biology Lab repository](https://github.com/gregconradismith/computational-biology-lab-at-william-and-mary-examples). Visitors looking for a concise scholarly record can browse [selected publications](/publications/) or download my [CV](/files/Greg_Conradi_Smith_Curriculum_Vitae.pdf).
